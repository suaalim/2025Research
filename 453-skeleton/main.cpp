...
int main() {
	...
	std::vector<std::tuple<int, int, glm::mat4, glm::mat4, glm::mat4, float, int>> edgeTransformations = SceneNode::extractEdgeTransforms("D:\\Program\\C++\\NewPhytologist2017\\articulated-structure\\plyFile\\transform_matrices9.txt");
